...
public abstract class ClientLauncher extends ApplicationCore implements Platform {
    ...
    public void setup() {
        ...
        Log.info("[RAM] Available: @ @", Strings.fixed(gb ? ram / 1024f / 1024 / 1024f : ram / 1024f / 1024f, 1),
                gb ? "GB" : "MB");
        ...
        assets.load(new AssetDescriptor<>(
                maxTextureSize >= 4096 ? "sprites/sprites.aatls" : "sprites/fallback/sprites.aatls",
                TextureAtlas.class)).loaded = t -> atlas = t;
    ...
    @Override
    public void pause() {
        // when the user tabs out on mobile, the exit() event doesn't fire reliably - in
        // that case, just assume they're about to kill the app
