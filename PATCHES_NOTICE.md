...
Patches that Mindustry Hotfix has that you may not want. (Requires a plugin).
...
Can be reverted by overriding admin events handler.
...
Can be reverted by setting `hfPierceIgnoresBuildingDamageMultiplier` to `true`.
